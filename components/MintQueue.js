...
const MintQueue = ({UpdateFunc}) => {
    ...
    <nav id="nav" className="navbar flex-col sticky-top w-full z-10">
        <div className="bg-backgroundColor w-full">
            <div className="mx-auto px-4">
                ...
                {for (let i = 0; i < selectedTokens.length; i++) {
                    <img src="https://ipfs.io/ipfs/bafybeifkcdoiltqlygw4veoue3cjs3tro6aeeqjf7napifdiqfsbsb3pj4/A1_preview.jpg"></img>
                    }
                }
                

                <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-purple-600 mr-20" viewBox="0 0 24 24">
            ...
            {expanded ? (
                <div className="block sm:hidden backgroundColor justify-right border-mainColor border-t-2 py-2">
                    <div className="flex flex-col justify-right items-right">
                        ...
                        <div className="flex justify-right items-right border-mainColor border-t-2 pt-2">
                            <a href="#" className="text-mainColor text-right text-lg font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">CONNECT WALLET</a>
                        </div>
                    </div>
                </div>
            ) : (
