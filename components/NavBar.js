...
const NavBar = ({connectWalletFunc, mintBulk, mintBulkInit, _bulkMintEnabled}) => {

    const [expanded, setExpaned] = useState(false);
    const [connected, setConnected] = useState(false);
    const [bulkMintEnabled, setBulkMintEnabledInternal] = useState(_bulkMintEnabled);
    ...
    mintBulkInit(setBulkMintEnabled);
    ...
    <nav id="nav" className="navbar sticky-top w-full z-10">
        <div className="bg-backgroundColor w-full">
            <div className="mx-auto px-4">
                ...
                <div className="hidden sm:flex sm:items-right">
                    ...
                    {bulkMintEnabled ? (        
                        <div>
                            <button className="text-md font-semibold bg-green-700 text-white rounded-lg px-4 py-2 block shadow-xl hover:bg-gray-700 mx-4"
                ...
                {bulkMintEnabled ? (        <div className="sm:hidden flex">
                                <button className="text-md font-semibold bg-green-700 text-white rounded-lg px-4 py-2 block shadow-xl hover:bg-gray-700 mx-4"
                                    onClick={mintBulkButton} data-tip data-for="mintBulkTip">
                                    MINT SELECTED
                                </button>
        ...
        </div>) : (<div className="sm:hidden flex"></div>)}
