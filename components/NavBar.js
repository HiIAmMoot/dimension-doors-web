...
// "bg-gray-5 font-sans w-full min-h-screen m-0 sticky-top"
//                 <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mr-4">Sign in</a>
const NavBar = () => {
    return (
    
    <nav id="nav" class="navbar sticky-top w-full">
        <div class="bg-white">
            <div class="mx-auto px-4">
                <div class="flex items-center justify-between py-4">
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-purple-600 mr-20" viewBox="0 0 24 24">
                ...
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mr-4">BUY</a>
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mr-4">UNLOCK</a>
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mr-4">ROADMAP</a>
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mr-4">TEAM</a>
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mr-4">GALLERY</a>
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mr-4">PROVENANCE</a>
                </div>

                <div class="hidden sm:flex sm:items-center">

                <a href="#" class="text-mainColor text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">CONNECT WALLET</a>
                </div>
            ...
            <div class="block sm:hidden bg-white border-t-2 py-2">
                ...
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mb-1">Products</a>
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mb-1">Marketplace</a>
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mb-1">Partners</a>
                <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mb-1">Pricing</a>
                <div class="flex justify-between items-center border-t-2 pt-2">
                    <a href="#" class="text-mainColor text-sm font-semibold hover:text-purple-600 mr-4">Sign in</a>
                    <a href="#" class="text-mainColor text-sm font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</a>
                </div>
                </div>
            </div>
            </div>
